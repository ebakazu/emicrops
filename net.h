...
#define NET_DEVICE_TYPE_ETHEERNeT 0x0002
...
extern int
net_device_output(struct net_device *dev, uint16_t type, const uint8_t *data, size_t lent, const void *dst);

extern int
net_input_handler(uint16_t type, const uint8_t *data, size_t lent, struct net_device *dev);
